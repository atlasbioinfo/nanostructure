...
class BaseRenderer:
    ...
    def draw_text(self, text, position, color, font_family='Arial', font_size='12px'):
        """Draw text element - to be implemented by specific renderer"""
        raise NotImplementedError

    def draw_line(self, start, end, color, width=1):
        """Draw line element - to be implemented by specific renderer"""
        raise NotImplementedError

    def draw_rectangle(self, position, size, color, opacity=1):
        """Draw rectangle element - to be implemented by specific renderer"""
        raise NotImplementedError

    def draw_polyline(self, points, color, width=1):
        """Draw polyline element - to be implemented by specific renderer"""
        raise NotImplementedError 